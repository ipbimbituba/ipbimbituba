...
export default function FormFields({
  ...
  const baseClasses = `bg-transparent  border-b-2 w-full border-gray-300 py-2 focus:outline-none focus:border-[#215D63] transition-colors placeholder:text-sm  xl:placeholder:text-base 2xl:placeholder:text-xl    placeholder:font-medium sm:text-xl text-gray-500 focus:placeholder-transparent `;
