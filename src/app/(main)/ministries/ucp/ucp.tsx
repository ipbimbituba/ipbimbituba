    ...
    <main className="bg-[#fdfbf7] text-[#1a1a1a] font-serif overflow-x-hidden selection:bg-blue-100 min-h-screen">
      ...
      <article className="xl:max-w-5xl 2xl:max-w-7xl mx-auto px-4 md:px-10 pb-40 pt-16">
        ...
        <motion.header
          ...
          variants={fadeIn}
        >
          <div className="flex flex-col md:flex-row justify-between items-center border-b border-black py-4 mb-8 font-sans xl:text-xs 2xl:text-sm uppercase tracking-[0.3em] font-black gap-4 text-center">
            <span>Imbituba - SC</span>
            <span className="font-black xl:text-xs 2xl:text-lg text-[#004a8d] border-x-2 border-black px-6 flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-9 text-center md:text-right space-y-4">
              <span className="text-zinc-500 font-sans font-black tracking-[0.4em] uppercase text-xs 2xl:text-sm block">
                Formando os Servos de Amanhã
              </span>
              <h1 className=" text-7xl xl:text-8xl 2xl:text-[11rem] font-sans font-black tracking-tighter leading-[0.8] text-[#004a8d] uppercase">
                UCP <br />{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 gap-y-20">
          ...
          >
            <div className="border-b-2 border-black pb-8">
              ...
              <h3 className="font-sans font-black uppercase xl:text-xl 2xl:text-3xl tracking-tighter text-black mb-4 uppercase">
                O QUE É?
              </h3>
            ...
            <div className="text-center italic text-zinc-500 border-t border-zinc-200 pt-8 text-sm 2xl:text-lg">
          ...
          >
            <div className="text-center border-y-2 border-black py-8 bg-[#fffcf0]">
              <h2 className="text-4xl xl:text-5xl 2xl:text-7xl font-sans font-black text-black uppercase tracking-tighter leading-none mb-2 uppercase">
                LIGA JUVENIL
              </h2>
              <p className=" text-base xl:text-xl 2xl:text-2xl font-serif text-[#004a8d] italic">
            ...
            <div className="md:columns-2 gap-10 space-y-8 text-lg md:text-xl leading-relaxed text-zinc-900 text-justify">
              <div className="flex items-center gap-2 text-[#004a8d] mb-4 break-inside-avoid">
                <History size={24} />
                <h3 className="xl:text-lg 2xl:text-xl font-black uppercase tracking-widest uppercase">
                  Memórias de 1940
                </h3>
              </div>

              <p className="first-letter:xl:text-7xl 2xl:text-8xl first-letter:font-black first-letter:text-[#004a8d] first-letter:float-left first-letter:mr-4 xl:text-base 2xl:text-lg first-letter:leading-none">
          ...
          <motion.aside
            className="space-y-12 border-l border-zinc-300 xl:p-3 2xl:p-6 lg:col-span-1"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
              ...
              <div className="space-y-8">
                {boardUCP.map((m, idx) => (
                  <div key={idx} className="flex items-center gap-4 group">
                    <div className="w-12 h-12 bg-zinc-800 rounded-full shrink-0 flex items-center justify-center border border-zinc-700 group-hover:border-[#ffcc00] transition-colors overflow-hidden">
                      <Users
                        size={20}
                    ...
                    <div>
                      <p className="xl:text-[7px] 2xl:text-[10px] font-sans font-black uppercase text-[#ffcc00] tracking-widest">
                        {m.role}
                      </p>
        ...
        >
          ...
          <p className="xl:max-w-3xl 2xl:max-w-4xl mx-auto xl:text-3xl 2xl:text-5xl font-serif italic text-zinc-700 mb-16 leading-tight">
